    ...
    <>
      ...
      >
        {showManualEntry ? (
            ...
            <Box sx={{ mt: 3 }}>
              <Card sx={{ p: 2 }}>
                ...
                <Box sx={{ float: "right", mt: 2 }}>
                  ...
                  <Button
                    onClick={() => changeShowManualEntry(false)}
                    variant="outlined"
                    color="error"
                  >
          ...
          <Container maxWidth={false}>
            <EmployeestimeToolbar
              changeShowWebClock={changeShowWebClock}
              changeShowManualEntry={changeShowManualEntry}
            />
            <Box sx={{ mt: 3 }}>
...
Employeestimesheets.getLayout = (page) => <DashboardLayout>{page}</DashboardLayout>;
