                ...
                <DialogContent>
                    <Grid sx={{ backgroundColor: 'grey' }} container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                        ...
                        <Grid item xs={12}>
                            ...
                            <FormControl fullWidth>
                                <Select labelId="demo-simple-select-label" id="demo-simple-select" value={'$ (USD)'} onChange={() => {}}>
                    ...
                    <TextField sx={{ mt: 10 }} label="Note" id="outlined-multiline-static" fullWidth multiline rows={4} />
                    <section
                        style={{
